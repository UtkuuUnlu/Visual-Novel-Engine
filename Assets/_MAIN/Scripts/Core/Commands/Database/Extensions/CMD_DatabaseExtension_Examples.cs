...
public class CMD_DatabaseExtension_Examples : CMD_DatabaseExtension
{
    new public static void Extend(CommandDatabase database)
    {
        ...
        database.AddCommand("lambda", new Action(() => {Debug.Log("Printing a default message through console from lambda command.");}));
    ...
    {
        Debug.Log("Printing a default message through console.");
    }
